...
function fillCity(){
    ...
    $.get(url,function(data,status){
    	...
    	$("#fcity").append(new Option("--------select------","--------select------"));
		for ( var i = 0; i < data.length; i++) {
			//alert(data[i][0].city);
			$("#fcity").append(new Option(data[i][0].ocity,data[i][0].ocity));
		}
	});
}
...
<div id="container" style="width: 100%;" >
 <form id="frm" style="background-image:url('background2.jpg'); height: 1300px; ">
...
<span class="right country" style="float: left">
<select id="fcity" style="height: 25px; width: 200px;" class="field select addr" onchange="fillFranchise();"  >

</select><label for="country" style="font-weight: bold;">City</label></span>
</li>
...
<div>
<input id="email" name="email" type="email" readonly="readonly" class="field text medium" maxlength="255" tabindex="1" required /> 
</div>
</li>
...
<span>
<input id="Dtype" name="Dtype" type="radio"  value="Home Delivery" checked="checked" tabindex="7"  required />
<label class="choice">
Home Delivery</label>
</span>
</div>
